...
public final class LinkedHashMap<K, V> extends AbstractMap<K, V, LinkedHashMap<K, V>> implements Serializable {
    ...
    public static <T, K, V> LinkedHashMap<K, V> ofAll(java.util.stream.Stream<? extends T> stream,
        ...
        return LinkedHashMap.<K, V>empty().ofStream(stream, entryMapper);
    }
    ...
    public static <T, K, V> LinkedHashMap<K, V> ofAll(java.util.stream.Stream<? extends T> stream,
        ...
        return LinkedHashMap.<K, V>empty().ofStream(stream, keyMapper, valueMapper);
    }
    ...
    @Override
    protected Function<Iterable<? extends Tuple2<K, V>>, LinkedHashMap<K, V>> ofEntriesInstance() {
        return LinkedHashMap::ofEntries;
    }

    @Override
    protected Supplier<LinkedHashMap<K, V>> emptyInstance() {
